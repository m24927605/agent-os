...
# CREDENTIAL-BLIND: report only the ENV KEY NAME, never the token value behind it.
echo "e2e:live-gmail: live env present (token KEY = ${AGENTOS_GMAIL_OAUTH_KEY}) — running the governed live self-send…"

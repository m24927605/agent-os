...
| **R6 inference routing gate** | design/inference-routing-gate.md | per-model deny-by-default ✅S1 DONE · egress allowlist(interim) · 接 PDP · 接 CostGate(model→成本) | P2-E, P2-G | Security Engineer |

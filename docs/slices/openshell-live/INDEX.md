...
| **OS-S2b** | `WatchSandbox`(server-stream readiness)→ 完成 `OpenShellReadinessTransport`(取代 getSandbox 輪詢)| 真 gateway | ✅ **DONE**(真實 watch 串流;grpcurl + live e2e 驗證;**6 個 RPC 完整 transport 達成**;獨立 review PASS)|

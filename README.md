...
- **Make the films — [Video Production Briefs](./docs/demo-video-briefs.md)** ([繁中 / zh-TW](./docs/demo-video-briefs.zh-TW.md)) — hand-off creative briefs for three cuts (60–75s Hero / 2–3 min Demo / 5–8 min Technical): narrative, visual system, motion + sound design, and acceptance criteria.
